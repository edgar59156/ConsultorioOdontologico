...
<a href="pacientes.report.php?action=create" class="btn btn-dark">
...
<table class="table">
    ...
    <?php foreach($datos as $key => $paciente): ?>
        <tr>
            ...
            <td>
                <a href="pacientes.php?action=show&id_paciente=<?=$paciente['id_paciente']?> " class="btn btn-success">
            ...
            <td>
                <a href="pacientes.php?action=consulta&id_paciente=<?=$paciente['id_paciente']?> " class="btn btn-info">
